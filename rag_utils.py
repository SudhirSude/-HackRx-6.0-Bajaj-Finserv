...
class TravelAssistant:
    ...
    def create_faiss_index(self):
        ...
        self.index = faiss.IndexFlatL2(dimension)  # L2 (Euclidean) distance metric for similarity comparison.
    ...
    def _prepare_model_input(self, params):
        ...
        common_routes = {
            # 🇮🇳 Domestic Routes (from dataset and known durations)
            ('Banglore', 'Delhi'): 171,
            ('Banglore', 'New Delhi'): 654,
            ('Chennai', 'Kolkata'): 139,
            ('Delhi', 'Cochin'): 817,
            ('Kolkata', 'Banglore'): 747,
            ('Mumbai', 'Hyderabad'): 191,
            ('Delhi', 'Mumbai'): 135,
            ('Delhi', 'Chennai'): 175,
            ('Mumbai', 'Bangalore'): 105,
            ('Hyderabad', 'Kolkata'): 150,
            ('Pune', 'Delhi'): 140,
            ('Ahmedabad', 'Mumbai'): 75,
            ('Jaipur', 'Delhi'): 60,

            # 🌍 Common International Routes (approximate durations)
            ('Delhi', 'Dubai'): 210,
            ('Mumbai', 'Dubai'): 180,
            ('Delhi', 'London'): 540,
            ('Mumbai', 'London'): 510,
            ('Delhi', 'New York'): 900,
            ('Mumbai', 'New York'): 870,
            ('Bangalore', 'San Francisco'): 1020,
            ('Delhi', 'Toronto'): 840,
            ('Chennai', 'Singapore'): 240,
            ('Mumbai', 'Singapore'): 310,
            ('Delhi', 'Bangkok'): 240,
            ('Mumbai', 'Bangkok'): 210,
            ('Hyderabad', 'Doha'): 250,
            ('Bangalore', 'Frankfurt'): 600
        }
